...
-- Schema sge
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bd_cadastro` DEFAULT CHARACTER SET utf8 ;
USE `bd_cadastro` ;
...
CREATE TABLE `bd_cadastro`.`cadastro_f` (
...
INSERT INTO `bd_cadastro`.`cadastro_f` (`codigo`, `nome_da_empresa`, `cnpj`, `email`, `endereco`, `comercial`, `celular`, `telefone_recado`) VALUES
...
--
ALTER TABLE `bd_cadastro`.`cadastro_f`
